  ...
  <div class="newAddress-page">
    ...
    <div class="newAddress-user-info">
      ...
      <div class="newAddress-user-name newAddress-user-input border-1px_bottom">
        <p class="newAddress-user-input"><span class="color505050">姓名</span><input type="text" placeholder="请填写姓名" v-model="name"></p>
      </div>
      <p class="newAddress-user-name newAddress-user-input border-1px_bottom newAddress-user-input-width1">
        <span class="color505050">微信号</span><input type="text" placeholder="请填写微信号" v-model="weixin_id">
      </p>
      <p class="newAddress-user-name newAddress-user-input border-1px_bottom">
        <span class="color505050">电话</span><input type="text" placeholder="请填写手机号" v-model="contacts">
      </p>
      <p class="newAddress-user-name newAddress-user-input border-1px_bottom newAddress-user-input-width">
        <span class="color505050">邮政编码</span><input type="text" placeholder="请填写邮政编码" v-model="zip_code">
      </p>
    </div>
    ...
    <div class="newAddress-user-info">
      ...
      <p class="newAddress-user-name newAddress-user-input border-1px_bottom newAddress-user-input-height">
        <span class="color505050">详细地址</span><textarea name="input" placeholder="请填写详细街道" v-model="address_detail"></textarea>
      </p>
    </div>
    <div class="newAddressEdit" @click="upNewAddress()">
      <router-link to="/me/address/newAddress">保存</router-link>
      <!--<router-link to="/me/address">保存</router-link>-->
    </div>
    <!-- 居住地址三级联动选项 -->
...
//*****************************
    ...
    methods: {
      ...
      upNewAddress(){
        ...
        formData.append('weixin_id', this.weixin_id);
        formData.append('name', this.name);
        formData.append('contacts', this.contacts);
        formData.append('zip_code', this.zip_code);
        formData.append('address_1', this.Province);
        formData.append('address_2', this.City);
        formData.append('address_3', this.District);
        formData.append('address_detail', this.address_detail);
        _this.$http.post('/api/setUserAddress', formData);
      },
//**********************************
      choseAdd: function() {
        this.showChose = true;
